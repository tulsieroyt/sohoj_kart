  ...
  String get message {
    switch (code) {
      ...
      case 'expired-action-code':
        return 'The action code is expired. Please request a new action code.';
      case 'missing-action-code':
        return 'The action code is missing. Please check the code and try again.';
      case 'user-token-expired':
        return 'The user\'s token has expired and authentication in required. Please sign in again.';
