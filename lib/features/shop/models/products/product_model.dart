...
import 'package:sohoj_kart/features/shop/models/products/product_attribute_model.dart';
...
class ProductModel {
  ...
  ///Convert json to model --> as a json or document
  ...
  ///Convert json to model --> as a stream or future
